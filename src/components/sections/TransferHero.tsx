            ...
            <div className="text-white space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl lg:text-2xl text-blue-100 leading-relaxed max-w-lg">
                  Antalya Havalimanı&apos;ndan otel ve tatil beldelerine güvenli, konforlu transfer hizmeti.
                  <br />
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/booking" className="group bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-2xl font-semibold text-lg transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/25 hover:scale-105 flex items-center justify-center space-x-3">
